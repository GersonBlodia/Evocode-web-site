...
export const MainHeader = () => {
  return (
    <div className="relative min-h-screen  bg-image ">
      ...
      <div className="relative z-20 w-11/12 md:w-4/5 mx-auto  h-full flex items-center pt-[6rem]   md:py-[10rem]">
        <div className="max-w-2xl">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold uppercase m-0 tracking-wide text-transparent [-webkit-text-stroke:1px_white] leading-tight">
          Impulsa tu
          </h1>
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-black uppercase text-white m-0 tracking-wide leading-tight">
      ...
      <div className="absolute right-0 top-0 h-full z-20 hidden md:block">
        <img
      ...
      <div className="absolute right-0 bottom-0 w-full h-1/2 z-20 md:hidden">
        <img
